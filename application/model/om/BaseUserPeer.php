...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Salt', 'IsActive', 'LastLogin', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'salt', 'isActive', 'lastLogin', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::PASSWORD, self::SALT, self::IS_ACTIVE, self::LAST_LOGIN, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'salt', 'is_active', 'last_login', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Salt' => 3, 'IsActive' => 4, 'LastLogin' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'salt' => 3, 'isActive' => 4, 'lastLogin' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::SALT => 3, self::IS_ACTIVE => 4, self::LAST_LOGIN => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'salt' => 3, 'is_active' => 4, 'last_login' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(UserCredentialPeer::USER_ID, $obj->getId());
