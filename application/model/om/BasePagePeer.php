...
abstract class BasePagePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Content', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'content', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CONTENT, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'content', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Content' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'content' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CONTENT => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'content' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
